  ...
  const contactMethods = [
    {
      ...
      label: "Email",
      value: "kumar494652@gmail.com",
      href: "mailto:kumar494652@gmail.com",
    ...
    },
    {
      ...
      label: "LinkedIn",
      value: "Sumit Kumar",
      href: "https://www.linkedin.com/in/sumit-kumar-8860a11ba/",
      gradient: "from-purple-500 to-purple-700"
    },
    {
      icon: "/social-icons/github-contact.svg",
      label: "GitHub",
      value: "SumitKumarSoftwareEngineer",
      href: "https://github.com/SumitKumarSoftwareEngineer",
            ...
            <motion.div variants={itemVariants} className="text-center lg:text-left">
              <div className="flex justify-center lg:justify-start mb-8">
                <div className="relative">
                  ...
                  >
                    <img
                      src="/local-uploads/WhatsApp Image 2025-09-12 at 16.41.55_eb1d9a8a.jpg"
                      alt="Sumit Kumar - Professional"
              ...
              >
                ...
                <p className="text-gray-300 leading-relaxed">
                 Whether you’re seeking a passionate developer eager to contribute to your team, exploring someone to collaborate on an exciting project, or simply looking to connect with a fellow tech enthusiast, I’d be glad to hear from you! I’m currently open to job and internship opportunities where I can learn, grow, and make a real impact.
                </p>
              </motion.div>
              ...
              >
                <Button
                  ...
                  onClick={() => window.open('mailto:kumar494652@gmail.com', '_blank')}
                >
