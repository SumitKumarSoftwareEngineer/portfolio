...
import { Github, Linkedin, Mail, ArrowDown, Code, Star, Terminal, Zap, Download } from 'lucide-react';
  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/SumitKumarSoftwareEngineer",
      color: "hover:text-white hover:bg-purple-800"
    },
    {
      name: "LinkedIn",
      icon: "/social-icons/linkedin-contact.svg",
      url: "https://www.linkedin.com/in/sumit-kumar-8860a11ba/",
      color: "hover:text-white hover:bg-purple-800"
    },
    {
      name: "Email",
      icon: "/social-icons/email-contact.svg",
      url: "mailto:kumar494652@gmail.com",
      color: "hover:text-white hover:bg-purple-800"
    },
    {
      name: "Location",
      ...
      <div className="absolute inset-0">
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            animate={{ x: [0, 100, 0], y: [0, -100, 0], scale: [0, 1, 0] }}
            transition={{
      ...
      <div className="container mx-auto px-4 relative z-10 w-full max-w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            ...
            >
              Vinoba Bhave University | Software Engineer
            </motion.p>
            ...
            >
              ...
              <a href="/resume.pdf" download className="w-full sm:w-auto">
                <Button
                  className="bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-white px-8 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-purple-500/25 w-full"
                  size="lg"
                >
